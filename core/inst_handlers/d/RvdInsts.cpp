...
namespace atlas
{
    ...
    void RvdInsts::getInstComputeAddressHandlers(std::map<std::string, Action> & inst_handlers)
    {
        ...
        inst_handlers.emplace(
            "fld", atlas::Action::createAction<&RvdInsts::computeAddressHandler<XLEN>, RvdInsts>(
                       nullptr, "fld", ActionTags::COMPUTE_ADDR_TAG));
        inst_handlers.emplace(
            "fsd", atlas::Action::createAction<&RvdInsts::computeAddressHandler<XLEN>, RvdInsts>(
    ...
    void RvdInsts::getInstHandlers(std::map<std::string, Action> & inst_handlers)
    {
        ...
        inst_handlers.emplace(
            "fld", atlas::Action::createAction<&RvdInsts::floatLsHandler<DP, true>, RvdInsts>(
        ...
        inst_handlers.emplace(
            "fsd", atlas::Action::createAction<&RvdInsts::floatLsHandler<DP, false>, RvdInsts>(
    ...
    template <typename XLEN> ActionGroup* RvdInsts::computeAddressHandler(atlas::AtlasState* state)
    {
        return RvfInstsBase::computeAddressHandler<XLEN>(state);
    }

    template <typename SIZE, bool LOAD>
    ActionGroup* RvdInsts::floatLsHandler(atlas::AtlasState* state)
    {
